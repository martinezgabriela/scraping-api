...
public class NoticiaController {
	...
	@ApiOperation(value = "Buscar notícia por id")
	@ApiResponses(value = {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Noticia> buscarNoticia(@PathVariable("id") Long id){
		return ResponseEntity.ok().body(noticiaService.buscarNoticiaById(id));
		
	}
	
	@ApiOperation(value = "Listar notícias")
	@ApiResponses(value = {
	...
	@PostMapping
	public ResponseEntity<Noticia> cadastrarNoticia(@Valid @RequestBody NoticiaDTO noticiaDto){
